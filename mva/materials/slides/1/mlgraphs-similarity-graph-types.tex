...
\newcommand{\topictitle}{Similarity Graph Types}

\newcommand{\topicsubtitle}{ε-neighborhood, k-NN, Fully Connected}
...
\end{block}
\pause
\begin{itemize}[<+-| alert@+>]\addtolength{\itemsep}{0.4\baselineskip}
